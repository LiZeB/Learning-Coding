...
public class my_link {
    public static void main(String args[]){
        ...
        //my_link.add(4);
        //my_link.read_link();
        //System.out.println("当前链表长度为：" + my_link.count_link());
        //my_link.delete_value(3);
        //my_link.read_link();
        //System.out.println("链表中间的元素为：" + Arrays.toString(my_link.middle_link()));
        //System.out.println("当前数字在链表的第：" + my_link.isContainsValue_link(4) + " 个位置");
        //my_link.insert_link(5,100);
        //my_link.read_link();
        //my_link.delete_link(4);
        //my_link.read_link();
        //System.out.println("当前链表长度为：" + my_link.count_link());
        //my_link.array2link(array);
        //node cur = new node(array[1]);
